...
const allowedOrigins = new Set([site, 'https://www.vedlikeholdt.no', 'http://127.0.0.1:5500', 'http://localhost:5500', 'http://127.0.0.1:58525', 'http://127.0.0.1:4173', 'http://localhost:4173', 'http://127.0.0.1:8080', 'http://localhost:8080']);
